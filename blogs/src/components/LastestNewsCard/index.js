...
const LastestNewsCard = (data) => {
    const postList = data.data;
    const sluglink = "/post/" + postList.slug;
    const relativeTime = require('dayjs/plugin/relativeTime')

    dayjs.extend(relativeTime);
    return (
        <div div className ="latest-news__card" >
            <article className="article-item">
                ...
                <div className="article-item__content">
                    <h2 className="article-item__title">
                        <a href="/only-someone-who's-seen-the-mummy-will-pass-this/">{postList.title}</a>
                    </h2>
                    <div className="article-item__info">
                        ...
                        <div className="article-item__info-right">
                            ...
                            <div className="article-item__datetime">
                                <div className="date">{dayjs(postList.date).format('DD/MM/YYYY')}</div>
                                <div className="time">
                                    ...
                                    { dayjs(postList.date).fromNow(true)}</div>
                            </div>
                        </div>
                    </div>
                </div>
